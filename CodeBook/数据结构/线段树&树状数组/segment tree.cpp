...
void Update(int rt, int begin, int end, int pos, int value,)//segTree[pos]+=value;
{
    if(begin==end)
    {
        segTree[rt]+=value;
...
void Update(int rt, int begin, int end, int value, int left, int right)//segTree[left,right]+=value
